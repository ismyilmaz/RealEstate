...
namespace RealEstateApp.Models
{
    ...
    partial void InsertModul(Modul instance);
    partial void UpdateModul(Modul instance);
    partial void DeleteModul(Modul instance);
    ...
    partial void DeleteUser(User instance);
		...
		public System.Data.Linq.Table<Modul> Moduls
		{
			get
			{
				return this.GetTable<Modul>();
			}
		}
    ...
    partial void OnDisctrictIDChanging(int value);
    partial void OnDisctrictIDChanged();
    ...
    partial void OnSeowordChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_DisctrictID", DbType="Int NOT NULL")]
		public int DisctrictID
		{
			get
			{
				return this._DisctrictID;
			}
			set
			{
				if ((this._DisctrictID != value))
				{
					if (this._District.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnDisctrictIDChanging(value);
					this.SendPropertyChanging();
					this._DisctrictID = value;
					this.SendPropertyChanged("DisctrictID");
					this.OnDisctrictIDChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Price", DbType="Decimal(15,0)")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="District_Ad", Storage="_District", ThisKey="DisctrictID", OtherKey="ID", IsForeignKey=true)]
		public District District
		{
			...
			set
			{
							...
							|| (this._District.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						value.Ads.Add(this);
						this._DisctrictID = value.ID;
					}
					else
					{
						this._DisctrictID = default(int);
					}
    ...
    partial void OnKinddetailMemberIDChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_KinddetailMemberID", DbType="Int NOT NULL")]
    ...
    partial void OnStatusChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_SymbolLeft", DbType="NVarChar(5)")]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_SymbolRight", DbType="NVarChar(5)")]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Value", DbType="Decimal(15,4)")]
    ...
    partial void OnStatusChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="District_Ad", Storage="_Ads", ThisKey="ID", OtherKey="DisctrictID")]
		public EntitySet<Ad> Ads
		{
			get
			{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.Modul")]
	public partial class Modul : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnControllerAndActionChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ControllerAndAction", DbType="NChar(255)")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Page_Permission", Storage="_Permissions", ThisKey="ID", OtherKey="PageID")]
		public EntitySet<Permission> Permissions
		{
			get
			{
    ...
    partial void OnPageIDChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Page_Permission", Storage="_Page", ThisKey="PageID", OtherKey="ID", IsForeignKey=true)]
		public Page Page
		{
			get
			{
